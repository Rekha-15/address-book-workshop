...
/**
 * main method,Printing welcome statement
 * 
 * @author rekha
 *
 */
public class AddressBook {
	...
	public static void main(String[] args) {
		...
		/**
		 * List is created with name of personDetail and storing this into the array
		 * having string type.
		 */
	...
	/**
	 * nameValidation is a method which is use to validate the fname and lname using
	 * regex pattern.
	 * 
	 * @param name
	 ...
	 * 
	 * @param mobileNum
	 * @return the boolean value checking the country code and 10 digit number must
	 *         be there
	 */
